...
impl ActionRunKind {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::StockBatchUpdate => "stock_batch_update",
            Self::StockMonitorUpdate => "stock_monitor_update",
            Self::StockPlanBuild => "stock_plan_build",
            Self::StockPeerPlanBuild => "stock_peer_plan_build",
            ...
            Self::OnchainComparisonConfigUpdate => "onchain_comparison_config_update",
            Self::OnchainBatchAdd => "onchain_batch_add",
            Self::OnchainBatchRemove => "onchain_batch_remove",
